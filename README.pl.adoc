...
. Poczekaj chwilkę, aż posty się wygenerują
. Włącz przeglądarkę internetową, wejdź w wybrany wątek i przeklej posty
...
* https://github.com/fotorelacjonusz/fotorelacjonusz-ng[Fotorelacjonusz-NG] —
  Fotorelacjonusz napisany od nowa dla Linuksa, MacOSa oraz Windowsa
* https://github.com/marteczek/photo-reporter[Photo Reporter] — aplikacja na Androida
